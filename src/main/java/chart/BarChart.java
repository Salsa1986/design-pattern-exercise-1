...
public class BarChart {
    ...
    public static class BarChartBuilder {
        ...
        public BarChartBuilder wirhBackgroundColor(String backgroundColor){
            this.backgroundColor = backgroundColor;
            return this;
        }
        ...
        public BarChartBuilder withDisplayTitle(boolean title){
            this.displayTitle = displayTitle;
            return this;
        }

        public BarChartBuilder withDisplayLegent(boolean displayLegend){
            this.displayLegend = displayLegend;
            return this;
        }
